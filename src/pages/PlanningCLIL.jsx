...
=== REGLAS DE DISEÑO ===
1. El desarrollo de clase (campo "The Hook") debe seguir los 8 pasos institucionales del colegio, y dentro del paso "Learn and Apply" incluir el método Singapur (Concreto → Pictórico → Abstracto).
...
7. Los 8 pasos del campo "The Hook" DEBEN estructurarse aplicando la metodología seleccionada arriba como principio organizador real, no como etiqueta. Guía por metodología: CLIL → andamiaje lingüístico explícito en cada paso (input comprensible, output guiado); Aprendizaje Significativo → activar y conectar saberes previos antes de cada nuevo concepto; ABP/PBL → fases de investigación, producción y socialización; Cooperativo → roles definidos e interdependencia positiva; Experiencial → experiencia directa, reflexión y aplicación; Visible Thinking → rutinas de pensamiento nombradas explícitamente; Maker/STEAM → prototipado y construcción interdisciplinar; Gamificación → mecánicas de puntos, niveles y retos; Neuropedagogía → pausas activas, atención y consolidación; Socioemocional → autorregulación y trabajo con emociones; Storytelling → hilo narrativo que atraviese los pasos.
